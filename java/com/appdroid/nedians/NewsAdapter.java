...
class NewsAdapter extends BaseAdapter {
    ...
    public NewsAdapter(Context context, ArrayList<String> data, ArrayList<String> data2){
        mContaxt = context;
        mData = data;
        mData2 = data2;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            mHolder.t1 = (TextView) convertView.findViewById(R.id.tn1);
            mHolder.t2 = (TextView) convertView.findViewById(R.id.tn2);
            convertView.setTag(mHolder);
        }
        else {
            mHolder = (ViewHolder) convertView.getTag();
        }
        if(mData.isEmpty()==false || mData2.isEmpty()==false){
